      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log("Hi");
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_10___default.a.post("http://localhost:4000/signin", {
              userId: userId,
              userPw: userPw
            });
          ...
          case 3:
            check = _context.sent;
            console.log(check);
            return _context.abrupt("return", check.data);
...
function () {
  ...
  /*#__PURE__*/
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.mark(function _callee2(state, action) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = _context2.t0 === "setId" ? 4 : _context2.t0 === "setPw" ? 5 : _context2.t0 === "setData" ? 6 : 11;
            break;
  ...
  return function signinReducer(_x3, _x4) {
...
/* harmony default export */ __webpack_exports__["default"] = (function (type) {
  switch (type) {
    case "isLogin":
      {
        return Object(react__WEBPACK_IMPORTED_MODULE_9__["useState"])(false);
      }
...
//# sourceMappingURL=index.js.98730ba2990c9096f01d.hot-update.js.map